function [exitStatus] = runAnalysisOfSimBatch(paramName1,paramName2,paramName3,param1Vals,param2Vals,param3Vals,i,j,k)
    ...
    tic
    processedDataPath=fullfile(PROCESSED_DATA_DIR,sprintf('%s_AnalysisResults_%d_%d_%d.mat',simName,i,j,k));
